        ...
        {status === "loading" ? (
          ...
          <>
            <Card>
              <View className="flex-row items-center gap-4">
                ...
                <Switch
                  ...
                  disabled={toggling || status === "denied" || status === "unsupported"}
                />
              </View>
            </Card>
            ...
            <View className="gap-1">
              <Text variant="caption" className="px-1 uppercase tracking-wider text-muted-foreground">
            ...
            <Text variant="caption" className="px-1 text-muted-foreground">
              Plateforme : {Platform.OS === "ios" ? "iOS (APNs via Expo)" : "Android (FCM via Expo)"}
            </Text>
          </>
        )}
      </ScrollView>
