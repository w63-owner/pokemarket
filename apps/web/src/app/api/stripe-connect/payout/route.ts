...
export async function POST(request: Request) {
  try {
    ...
    try {
      ...
      // can try again. Use an additive RPC: a new sale may have credited the
      // wallet after we reserved this payout, and an absolute reset would
      // overwrite that newer balance.
