 ...
 *   1. Do NOT restore the platform wallet here. This event is emitted by the
 *      connected account after our platform transfer has already succeeded; a
 *      failed bank payout returns funds to the seller's Stripe balance, not to
 *      the platform.
