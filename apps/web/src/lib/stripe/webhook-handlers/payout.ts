 ...
 *
 * IMPORTANT: Do not restore the app wallet here. The platform transfer has
 * already succeeded, and Stripe returns a failed bank payout to the connected
 * account balance. Re-crediting our ledger would let the seller withdraw the
 * same funds twice.
 */
