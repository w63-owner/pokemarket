 ...
 *   1. Do NOT restore the in-app available_balance. At this point the platform
 *      transfer has already moved funds to the connected account; a failed bank
 *      payout returns funds to that connected account balance, not to the
 *      platform wallet. Restoring here would let the seller withdraw twice.
