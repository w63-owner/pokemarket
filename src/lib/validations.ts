...
export const listingCreateSchema = z
  .object({
    ...
    grade_note: z.number().min(1).max(10).nullish(),
    delivery_weight_class: z.enum(WEIGHT_CLASSES).default(DEFAULT_WEIGHT_CLASS),
    ...
    card_language: z.string().nullish(),
    card_rarity: z.string().nullish(),
    card_illustrator: z.string().nullish(),
  })
  .refine(
    (data) => {
